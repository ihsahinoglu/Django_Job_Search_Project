...
urlpatterns = [
                  ...
                  path('job-list/<str:query_word>/<str:query_city>/<str:query_category>/', views.jobList, name='job-list'),
                  ...
                  path('candidates-profile/<slug:slug>/', views.candidatesProfile, name='candidates-profile'),
